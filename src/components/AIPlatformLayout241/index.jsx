        ...
        <div className="flex flex-col gap-12 items-center justify-start w-full">
          ...
          >
            <div className="flex flex-1 flex-col gap-6 items-start justify-start w-full">
              ...
              <Text
                className="leading-[150.00%] max-w-[432px] md:max-w-full text-base text-black-900"
            ...
            <div className="flex flex-1 flex-col gap-6 items-start justify-start w-full">
              ...
              />
              <Text
                className="leading-[130.00%] max-w-[432px] md:max-w-full md:text-3xl sm:text-[28px] text-[32px] text-black-900"
                size="txtRobotoBold32"
              >
